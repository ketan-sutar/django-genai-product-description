"""
Django settings for ai_product project.
...
SECRET_KEY = 'django-insecure-=6=q6ujl+iayyt!2#@!gxi=3o7%r)#1dafb@=vk^r=e9+y$s0%'
...
WSGI_APPLICATION = 'ai_product.wsgi.application'
